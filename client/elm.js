...
Elm.ExternalCSS.make = function (_elm) {
   "use strict";
   _elm.ExternalCSS = _elm.ExternalCSS || {};
   if (_elm.ExternalCSS.values) return _elm.ExternalCSS.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   var stylesheet = function (href) {
      var children = _U.list([]);
      var attrs = _U.list([A2($Html$Attributes.attribute,
                          "rel",
                          "stylesheet")
                          ,A2($Html$Attributes.attribute,"property","stylesheet")
                          ,A2($Html$Attributes.attribute,"href",href)]);
      var tag = "link";
      return A3($Html.node,tag,attrs,children);
   };
   return _elm.ExternalCSS.values = {_op: _op
...
Elm.Types.make = function (_elm) {
   ...
   var JediResource = F2(function (a,b) {
      return {id: a,url: b};
   });
...
Elm.Main.make = function (_elm) {
   ...
   return _elm.Main.values = {_op: _op,main: main,model: model};
};
Elm.Fetch = Elm.Fetch || {};
Elm.Fetch.make = function (_elm) {
   "use strict";
   _elm.Fetch = _elm.Fetch || {};
   if (_elm.Fetch.values) return _elm.Fetch.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   $Types = Elm.Types.make(_elm);
   var _op = {};
   var parseResource = A3($Json$Decode.object2,
   F2(function (id,url) {    return {id: id,url: url};}),
   A2($Json$Decode._op[":="],"id",$Json$Decode.string),
   A2($Json$Decode._op[":="],"url",$Json$Decode.string));
   var parseJedi = A5($Json$Decode.object4,
   F4(function (id,name,master,apprentice) {
      return {id: id
             ,name: name
             ,master: master
   ...
   A2($Json$Decode._op[":="],"master",parseResource),
   A2($Json$Decode._op[":="],"apprentice",parseResource));
   var lookupDarkJedi = function (query) {
      return A2($Http.get,
      parseJedi,
      A2($Basics._op["++"],
   ...
   return _elm.Fetch.values = {_op: _op
                              ,lookupDarkJedi: lookupDarkJedi};
};
